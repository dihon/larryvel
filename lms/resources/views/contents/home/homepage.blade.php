                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-7 col-md-8">
                        <div class="hero__caption">
                            ...
                            <h1 data-animation="fadeInLeft" data-delay=".5s" >Lorem ipsum dolor sit amet</h1>
                            <p data-animation="fadeInLeft" data-delay=".9s">consectetur adipiscing elit. Ut semper, lorem a auctor dignissim, ex odio faucibus nisl, placerat hendrerit erat mauris id sem. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
                            <!-- Hero-btn -->
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6">
                <div class="support-location-img">
                    <img src="./dist/img/gallery/about.png" alt="">
                </div>
            </div>
            <div class="col-xl-6 col-lg-6">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-10">
                <div class="single-services mb-100">
                    <div class="services-img">
                        <img src="./dist/img/gallery/services1.png" alt="">
                        </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-10">
                <div class="single-services mb-100">
                    <div class="services-img">
                        <img src="./dist/img/gallery/services2.png" alt="">
                        </div>
                        <div class="services-caption">
                        <span>Strategy planing</span>
                        <p><a href="#">Within the construction industry as their overdraft</a></p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-10">
                <div class="single-services mb-100">
                    <div class="services-img">
                        <img src="./dist/img/gallery/services3.png" alt="">
                        </div>
                        <div class="services-caption">
                        <span>Strategy planing</span>
                        <p><a href="#">Within the construction industry as their overdraft</a></p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-10">
                <div class="single-services mb-100">
                    <div class="services-img">
                        <img src="./dist/img/gallery/services4.png" alt="">
                        </div>
                        <div class="services-caption">
                        <span>Strategy planing</span>
                        <p><a href="#">Within the construction industry as their overdraft</a></p>
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                <div class="founder-img">
                                    <img src="./dist/img/gallery/Homepage_testi.png" alt="">
                                </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="./dist/img/gallery/team2.png" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="./dist/img/gallery/team3.png" alt="">
                    </div>
                    <div class="team-caption">
                        <h3><a href="#">John Smith</a></h3>
                        <span>Trainer</span>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="./dist/img/gallery/team1.png" alt="">
                    </div>
                    <div class="team-caption">
                        <h3><a href="#">John Smith</a></h3>
                        <span>Trainer</span>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="./dist/img/gallery/home_blog1.png" alt="">
                            <ul>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="./dist/img/gallery/home_blog2.png" alt="">
                            <ul>
                                <li>By Admin   -   October 27, 2020</li>
                            </ul>
                        </div>
    ...
    <div class="container">
        <div class="brand-active brand-border pb-40">
            <div class="single-brand">
                <img src="./dist/img/gallery/brand1.png" alt="">
            </div>
            <div class="single-brand">
                <img src="./dist/img/gallery/brand2.png" alt="">
            </div>
            <div class="single-brand">
                <img src="./dist/img/gallery/brand3.png" alt="">
            </div>
            <div class="single-brand">
                <img src="./dist/img/gallery/brand4.png" alt="">
            </div>
            <div class="single-brand">
                <img src="./dist/img/gallery/brand2.png" alt="">
            </div>
            <div class="single-brand">
                <img src="./dist/img/gallery/brand5.png" alt="">
            </div>
        </div>
    </div>
</div> -->
